		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#turnosmedicos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"turnosmedicos-display": {
								"semanticObject": "turnosmedicos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=turnosmedicos",
									"url": sap.ui.require.toUrl("turnosmedicos")
								}
							}
						}
					}
